...
# ✅ Step 6: Disease keywords for exact match
disease_keywords = {
...
def predict_disease(user_input):
    ...
    # 2️⃣ If no keyword match, use AI model
...
# ✅ Step 2: Dataset with serious diseases + mental health issues
data = {
    "symptoms": [
        "chest_pain shortness_of_breath sweating mouth_pain",   # Heart Disease
        "high_sugar fatigue frequent_urination teeth_pain",    # Diabetes
...
# ✅ Step 5: Keyword dictionary for exact words
disease_keywords = {
...
# ✅ Step 6: Prediction function using keywords first, fallback AI
def predict_disease(user_input):
    user_words = user_input.lower().split()
...
# --- Header ---
st.title("🩺 AI Medicine Recommender System")
st.markdown("""
